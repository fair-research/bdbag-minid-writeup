...
(https://ncats.nih.gov/translator) is using BDBags
...
\item
Finally, we note that BDBags are starting to see use outside biomedicine. For example, they are being integrated
