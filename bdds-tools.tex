...
representing the ABIDE preprocessed dataset available here: \smallurl{https://bd2kcat1.ini.usc.edu/abide/search/}.}
\end{figure}
...
Users new to BDBag and Bagit technology can download the BDBag GUI application for Windows an MacOSX systems from
\smallurl{https://github.com/ini-bdds/bdbag_gui/releases}.  The BDBag GUI provides an intuitive graphical interface for
working with any Bagit specification-compliant bag directory or archive, making the creation, consumption, and
materialization of BDBags trivially easy for those who want a point-and-click user experience.

\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{figs/bdbag_gui_fetch.png}
\caption{}}
\end{figure}
