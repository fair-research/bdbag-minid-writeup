...
Figure~\ref{fig:gui} shows the GUI.
...
A researcher uses either the web interface or the command line interface to specify required data,
...
The resulting BDBag encapsulates references to the files in question, metadata associated with those files, the query used to identify the data, and the checksums required to validate the files and metadata.
