...
\begin{enumerate}
\item
The BDBag exchange format and Minid identifier for the exchange of big scientific data,
...
\item
High-quality open source implementations of a comprehensive set of  
command line tools and Python APIs for manipulating BDBags and Minids.
...
\item
Integration of BDBag and Minid mechanisms with a range of other tools, 
such as Globus and Galaxy 
to provide end-to-end solutions to the problem of organizing and sharing big data. 

\item
Compelling example applications that demonstrate the value of BDBag and Minid capabilities,
such as an ENCODE portal, transcription factor binding site analysis~\cite{}, and
XXX.
